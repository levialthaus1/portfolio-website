    ...
    >
      ...
      <div className="absolute z-10 flex flex-col items-center">
        ...
        <div className="w-37.5 h-37.5 relative" data-aos="fade-up">
          <div
            className={`absolute inset-0 rounded-full bg-linear-to-r from-blue-500 
        ...
        <h1
          data-aos="fade-up"
          data-aos-delay="200"
          className="text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl my-6 
      font-bold tracking-wide text-transparent bg-clip-text bg-linear-to-r 
