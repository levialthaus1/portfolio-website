...
export default function ResumeCard({
  ...
  return (
    <div className="flex items-start space-x-6 bg-blue-950/20 p-4 sm:p-8 rounded-md">
      <div
        className="w-10 h-10 sm:w-14 sm:h-14 bg-blue-950 rounded-full grid
      place-items-center"
      >
      ...
      <div className="flex-1">
        {date && (
            <p className="mb-2 px-4 py-1 sm:py-1.5 rounded-full bg-gray-300 
        ...
        <p className="text-xs sm:text-base text-gray-500 tracking-wide">
            {subDescription}
        </p>
      </div>
    </div>
